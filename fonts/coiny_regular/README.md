...
import (
  ...
  _ "github.com/gmlewis/go-fonts-c/fonts/coiny_regular"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from coiny_regular"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "coiny_regular", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
