...
![chivo_bolditalic](chivo_bolditalic.png)
...
func main() {
  ...
  message := "Sample from chivo_bolditalic"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "chivo_bolditalic", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
