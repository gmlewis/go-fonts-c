...
import (
  ...
  _ "github.com/gmlewis/go-fonts-a/fonts/combinumeralsltd"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from combinumeralsltd"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "combinumeralsltd", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
