...
import (
  ...
  _ "github.com/gmlewis/go-fonts-c/fonts/cacchampagne"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from cacchampagne"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "cacchampagne", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
